...
STATE(big_turn,   500,  AUTO_TURN(9, 127),       auto_turn_init,     auto_turn_loop,     big_jerk,   big_jerk,   auto_turn_isdone)
STATE(big_jerk,   350,  AUTO_ARM(100, 127),      auto_arm_init,      auto_arm_loop,      big_fall,   big_fall,   auto_none_isdone)
STATE(big_fall,   2000, AUTO_WAIT(),             auto_none_init,     auto_none_init,     big_drive,  big_drive,  auto_none_isdone)
...
STATE(big_shove,  600,  AUTO_STRAIGHT(50, -127), auto_straight_init, auto_turn_init,     big_pickup, big_pickup, auto_straight_isdone)
...
STATE(big_turn,   2000, AUTO_TURN(22, -127),     auto_turn_init,     auto_turn_loop,     big_jerk,   big_jerk,   auto_turn_isdone)
/* Prevent the arm from digging into the foam mat. */
STATE(big_jerk,   800,  AUTO_ARM(0, 127),        auto_arm_init,      auto_arm_loop,      big_drive,  big_drive,  auto_none_isdone)
STATE(big_drive,  8000, AUTO_STRAIGHT(500,-127), auto_straight_init, auto_straight_loop, big_jig,    big_jig,    auto_straight_isdone)
STATE(big_jig,    2000, AUTO_TURN(15, 127),      auto_turn_init,     auto_turn_loop,     big_pickup, big_pickup, auto_turn_isdone)
