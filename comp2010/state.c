...
STATE(init_back,  1e5,  AUTO_STRAIGHT(30, -127), auto_straight_init, auto_straight_loop, init_dump1, done, auto_straight_isdone)
STATE(init_dump1, 1e5, AUTO_RAMP(100, 127),     auto_ramp_init,     auto_ramp_loop,     init_dump2, done, auto_ramp_isdone) 
STATE(init_dump2, 1e5, AUTO_WAIT(),             auto_none_init,     auto_none_loop,     init_jig1,  done, auto_none_isdone)
STATE(init_jig1,  1e5, AUTO_TURN(30, -127),     auto_turn_init,     auto_turn_loop,     init_jig2,  done, auto_turn_isdone)
STATE(init_jig2,  1e5, AUTO_TURN(60,  127),     auto_turn_init,     auto_turn_loop,     init_jig3,  done, auto_turn_isdone)
STATE(init_jig3,  1e5, AUTO_TURN(30, -127),     auto_turn_init,     auto_turn_loop,     init_dump3, done, auto_turn_isdone)
STATE(init_dump3, 1e5, AUTO_RAMP(0, -127),      auto_ramp_init,     auto_ramp_loop,     done,       done, auto_ramp_isdone)
STATE(done,       1,    AUTO_WAIT(),             auto_none_init,     auto_none_loop,     done,       done, auto_none_isdone)
